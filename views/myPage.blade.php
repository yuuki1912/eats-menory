            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('eats.userEdit') }}">アカウント編集</a></li>
                        <li class="nav-item">
                            <a href="{{ route('eats.userDelete') }}" class="nav-link"
                                onclick="confirm('本当に退会しますか？');
                                event.preventDefault();
                                document.getElementById('withdrawal-form').submit();">
                                アカウント削除
                            </a>
                                <form id="withdrawal-form" action="{{ route('eats.userDelete') }}" method="post" style="display: none;">
                                    {{ csrf_field() }}
                                </form>
                        </li>
